...
{
    public partial class U_PaperLife: DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void btn_Query_Click(object sender, EventArgs e)
        {
            ...
            DataSet detailDS = this._WMSAccess.Select_T_Product_In(productids);
            this.grid_Detail.DataSource = detailDS.Tables["T_Product_In"];
