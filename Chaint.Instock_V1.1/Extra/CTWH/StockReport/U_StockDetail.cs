...
{
    public partial class U_StockDetail : DevExpress.XtraEditors.XtraUserControl
    {
        CTWH.Common.MSSQL.WMSAccess _WMSAccess;

        public U_StockDetail()
        {
            InitializeComponent();
        }
        ...
        private void U_StockDetail_Load(object sender, EventArgs e)
        {
            ...
            this.dt_Start.DateTime = DateTime.Now.AddDays(-1);
        }
        private void btn_Query_Click(object sender, EventArgs e)
        {
            string dateS = this.dt_Start.EditValue.ToString();
            string dateE = this.dt_End.EditValue.ToString();
        DataSet detailDS = this._WMSAccess.Select_StockDetail(dateS,dateE);
