...
namespace Chaint.Common.Devices.IO
{
    ...
    /// 该类不运行被继承
    /// </summary>
    public sealed class GetCurrentDir
    {
        private static GetCurrentDir soGetCurrentDir = new GetCurrentDir();
    ...
    public class CFile
    {
        ...
        static public MemoryStream ReadFileToStream(String FileName)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception(String.Format("Read File : {0} Fail! ErrMsg={1}", FileName, e.Message));
            }
        ...
        static public void ReadFileToChars(String FileName, out Char[] buf, String Encode)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception(String.Format("Read File : {0} Fail,the reason:{1}", FileName,e.Message));
            }
        ...
        public static void WriteStream(String FileName, MemoryStream In)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception(String.Format("Write File : {0} Fail,the reason:{1}", FileName, e.Message));
            }
