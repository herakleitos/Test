...
{
    public class PLCOperation5D6 : PLCProdave5D6, IPLCOperation, IDisposable
    {
        #region 变量定义
        ...
        public PLCOperation5D6(PLCConnItem plcConnect)
        {
        ...
        public PLCOperation5D6(int ConnNr,int Address, int Segment, int Rack, int Slot)
        {
