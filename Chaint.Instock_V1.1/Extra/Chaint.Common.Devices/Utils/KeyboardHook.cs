...
/* 来源：http://www.codeproject.com/Articles/28064/Global-Mouse-and-Keyboard-Library
 * 使用方法:
  *  (1) 创建实例：KeyboardHook keyboardHook = new KeyboardHook();;
  *  (2) 可订制事件:    keyboardHook.KeyDown += new KeyEventHandler(keyboardHook_KeyDown);
                        keyboardHook.KeyUp += new KeyEventHandler(keyboardHook_KeyUp);
                        keyboardHook.KeyPress += new KeyPressEventHandler(keyboardHook_KeyPress);
 *   (3) 开始捕获消息:  keyboardHook.Start();
 *   (4) 停止捕获消息： keyboardHook.Stop();
 */
