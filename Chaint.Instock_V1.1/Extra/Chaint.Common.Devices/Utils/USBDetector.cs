...
namespace Chaint.Common.Devices.Utils
{
    ...
    internal class DetectorForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label.Size = new System.Drawing.Size(395, 12);
    ...
    /// Use it in   or   steps:
    ///  ) Create instance of this class in your project and add handlers for the
    /// DeviceArrived, DeviceRemoved and QueryRemove events.
    /// AND (if you do not want drive detector to creaate a hidden form))
    ///  ) Override WndProc in your form and call DriveDetector's WndProc from there. 
    /// If you do not want to do step  , just use the DriveDetector constructor without arguments and
    ...
    class USBDetector : IDisposable
    {
                    ...
                    case DBT_DEVICEQUERYREMOVE:
                        ...
                        if (devType == DBT_DEVTYP_HANDLE)
                        {
                            ...
                            if (tempQuery != null)
                            {
                                ...
                                {
                                    // Change   .  .    : Unregister the notification, this will
        ...
        /// <summary>
        /// New:   .  .     - handle to root directory of flash drive which is opened
        ...
        private void RegisterQuery(string drive)
        {
            ...
            if (mFileToOpen == null)
            {
                // Change   .  .     - Open the root directory if no file specified - leave mFileToOpen null 
                // If client gave us no file, let's pick one on the drive... 
                //mFileToOpen = GetAnyFile(drive);
                //if (mFileToOpen.Length ==  )
            ...
            try
            {
                ...
                // Change   .  .     - Open the root directory 
        ...
        private void RegisterForDeviceChange(bool register, SafeFileHandle fileHandle)
        {
            ...
            else
            {
                ...
                if (mDirHandle != IntPtr.Zero)
                {
                    ...
                    //    string er = Marshal.GetLastWin  Error().ToString();
                }
        ...
        /// <summary>
        /// Gets drive letter from a bit mask where bit   = A, bit   = B etc.
        ...
        public struct DEV_BROADCAST_HANDLE
        {
            ...
            //public byte[] dbch_data[ ]; // = new byte[ ];
