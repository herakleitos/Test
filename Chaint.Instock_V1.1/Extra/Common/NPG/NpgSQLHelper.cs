...
namespace Common.NPG
{
    ...
    public sealed class NpgSqlHelper
    {
        ...
        /// <summary>
        /// This method is used to attach array of NpgNpgsqlParameters to a NpgNpgsqlCommand.
        /// 
        ...
        /// </summary>
        /// <param name="command">The NpgNpgsqlCommand to be prepared</param>
        ...
        /// <summary>
        /// Execute a NpgNpgsqlCommand (that returns no resultset and takes no parameters) against the database specified in 
        ...
        /// <summary>
        /// Execute a NpgNpgsqlCommand (that returns no resultset) against the database specified in the connection string 
        ...
        /// <summary>
        /// Execute a stored procedure via a NpgNpgsqlCommand (that returns no resultset) against the database specified in 
        ...
        /// <summary>
        /// Execute a NpgNpgsqlCommand (that returns no resultset and takes no parameters) against the provided NpgsqlConnection. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a NpgNpgsqlCommand (that returns no resultset) against the specified NpgsqlConnection 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a stored procedure via a NpgNpgsqlCommand (that returns no resultset) against the specified NpgsqlConnection 
        ...
        /// <summary>
        /// Execute a NpgNpgsqlCommand (that returns no resultset and takes no parameters) against the provided NpgsqlTransaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a NpgNpgsqlCommand (that returns no resultset) against the specified NpgsqlTransaction
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
