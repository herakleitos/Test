...
namespace Common.Oracle
{
    ...
    /// <summary>
    /// The Oracle.OracleOleDbHelper class is intended to encapsulate high performance, scalable best practices for 
    /// common uses of SqlClient
    /// </summary>
    public sealed class OracleOleDbHelper
    {
        #region private utility methods & constructors

        // Since this class provides only static methods, make the default constructor private to prevent 
        // instances from being created with "new Oracle.OracleOleDbHelper()"
        private OracleOleDbHelper() { }
        ...
        /// <summary>
        /// This enum is used to indicate whether the connection was provided by the caller, or created by Oracle.OracleOleDbHelper, so that
        /// we can set the appropriate CommandBehavior when calling ExecuteReader()
        /// </summary>
        private enum SqlConnectionOwnership
        {
            /// <summary>Connection is owned and managed by Oracle.OracleOleDbHelper</summary>
            Internal,
        ...
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">An array of SqlParameters to be associated with the command or 'null' if no parameters are required</param>
        /// <param name="connectionOwnership">Indicates whether the connection parameter was provided by the caller, or created by Oracle.OracleOleDbHelper</param>
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static OleDbDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static OleDbDataReader ExecuteReaderTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static OleDbDataReader ExecuteReaderTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(OleDbConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(OleDbTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Oracle.OracleOleDbHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Oracle.OracleOleDbHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        //        return Oracle.OracleOleDbHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return Oracle.OracleOleDbHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
        //    }
        //}
        ...
        //        return Oracle.OracleOleDbHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return Oracle.OracleOleDbHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
        //    }
        //}
        //#endregion
