...
namespace DialogflowTest
{
    public class DetectIntentTexts
    {
        ...
        public static string DetectIntentFromTexts(string question, string projectId, string sessionId, string authJSONPath)
        {
            ...
            {
                token = TokenService.GetToken(authJSONPath).Result;
            }
            ...
            {
                score = Convert.ToString(response.QueryResult.IntentDetectionConfidence);
            ...
            Myfile.Write("E:\\", "result.txt", string.Format("\"{0}\",{1}", question, score));
            return sb.ToString();
        }
    }
}
