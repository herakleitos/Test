...
tf.flags.DEFINE_integer(
  "min_word_frequency", 3, "Minimum frequency of words in the vocabulary")

tf.flags.DEFINE_integer("max_sentence_len", 160, "Maximum Sentence Length")

tf.flags.DEFINE_string(
  "input_dir", os.path.abspath("./data/100_thound_sample"),
  "Input directory containing original CSV data files (default = './data')")

tf.flags.DEFINE_string(
  "output_dir", os.path.abspath("./data/100_thound_sample"),
...
if __name__ == "__main__":
  ...
  vocab.save(os.path.join(FLAGS.output_dir, "vocab_processor.pickle"))
