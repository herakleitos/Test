...
# Model Parameters
tf.flags.DEFINE_integer("embedding_dim", 160, "Dimensionality of the embeddings")
tf.flags.DEFINE_integer("rnn_dim", 256, "Dimensionality of the RNN cell")
tf.flags.DEFINE_integer("max_context_len", 512, "Truncate contexts to this length")
tf.flags.DEFINE_integer("max_utterance_len", 160, "Truncate utterance to this length")

# Pre-trained embeddings
""" tf.flags.DEFINE_string("glove_path", r'E:/Demo Code/Tensorflow/chatbot-retrieval-master/data/vocab_processor.pickle', "Path to pre-trained Glove vectors")
tf.flags.DEFINE_string("vocab_path", r'E:/Demo Code/Tensorflow/chatbot-retrieval-master/data/vocabulary.txt', "Path to vocabulary.txt file") """
