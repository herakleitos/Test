...
tf.flags.DEFINE_integer("max_context_len", 320, "Truncate contexts to this length")
...
tf.flags.DEFINE_integer("batch_size", 1024, "Batch size during training")
tf.flags.DEFINE_integer("eval_batch_size", 1024, "Batch size during evaluation")
