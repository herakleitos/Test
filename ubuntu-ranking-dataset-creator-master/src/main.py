import argparse
import create_ubuntu_dataset as create_dataset
...
parser.add_argument('-o', '--output', default= r'E:\Demo Code\Tensorflow\ubuntu-ranking-dataset-creator-master\output\no greeting message\1000_thound_sample',
                        help='output csv')
...
parser.add_argument('-e', '--examples', type=int, default=1000000, help='number of examples to generate')
